...
#BLOCKS ((5*4)*N_BLOCKS bytes, str|int32)
#DATA (variable size)
...
VERSION = np.int32(1)
N_BLOCKS = np.int32(7)
BLOCKS = ["AVERG", "WIG", "FPS", "DESCR", "PROJE", "WEIGH", "CONF"]
def write_header(SALTED_file):
    ...
    #Leaf (5*4)*N_Blocks bytes for the block names and locations (5bytes for the name, 4 bytes for the location)
