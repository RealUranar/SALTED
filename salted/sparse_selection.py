...
from salted.sys_utils import ParseConfig, get_atom_idx, read_system, do_fps
...
def build():
    ...
    species, lmax, nmax, llmax, nnmax, ndata, atomic_symbols, atomic_coords, natoms, natmax = read_system(conf_indices=train_indices)
